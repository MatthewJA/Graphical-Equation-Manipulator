...
(function() {
  ...
  define('terminals',["parse", "generateInfo", "nodes"], function(parse, generateInfo, nodes) {
...
(function() {
  ...
  define('operators/Mul',["nodes", "terminals", "generateInfo", "AlgebraError", "parseArgs", "require", "compare"], function(nodes, terminals, generateInfo, AlgebraError, parseArgs, require, compare) {
...
(function() {
  ...
  define('operators/Pow',["nodes", "terminals", "generateInfo", "AlgebraError", "parseArgs", "require", "compare"], function(nodes, terminals, generateInfo, AlgebraError, parseArgs, require, compare) {
    var Pow;
  ...
  define('prettyRender',[],function() {
    ...
    Pow = (function(_super) {
      ...
      Pow.prototype.renderString = function() {
        return "" + (this.left.renderString()) + "^(" + (this.right.renderString()) + ")";
      };
    ...
    Fraction = (function(_super) {
      ...
      Fraction.prototype.renderString = function() {
        return "(" + (this.top.renderLaTeX()) + ")/(" + (this.bottom.renderLaTeX()) + ")";
      };
